...
PERTURBATION = .00001 #perturbation for finite difference method
MAX_ITERATIONS = 1 #10
...
def ik_cost(end_effector_pos, guess):
    ...
    #print(calculated_end_effector_pos)
    # Extract position from the calculated homogeneous transformation matrix
    calculated_end_effector_pos = calculated_end_effector_pos[:3, 3]
    #print(calculated_end_effector_pos)
    # Calculate Euclidean distance between the desired and calculated positions
...
def calculate_jacobian_FD(joint_angles, delta):
    ...
    for i in range(3):
        ...
        #print(perturbed_end_effector_pos)
        ...
        #print(original_end_effector_pos)
...
#print(calculate_jacobian_FD([1,2,3], 1))
...
print(calculate_inverse_kinematics([1,2,3], [1,2,3]))
